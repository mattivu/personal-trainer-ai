...
import { parseNutritionDateQuery } from "@/lib/nutrition/date";
import {
...
export default async function NutritionPage({ searchParams }: NutritionPageProps) {
  ...
  try {
    ...
    const primaryActivity = activityEstimate.activities[0]?.workoutName ?? null;
